...
export default function CustomersPage() {
  ...
  return (
    <main className="flex-1 p-8 lg:p-12 overflow-auto">
      <Breadcrumbs items={[{ label: "Overview", href: "/manager" }, { label: "Customers" }]} accentClass="hover:text-accent-copper" />
      ...
      <div className="space-y-3">
        ...
        {!loading && customers.map(c => (
          <Link key={c.id} href={`/manager/customers/${c.id}`} className="block">
